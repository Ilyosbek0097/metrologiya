                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.delete_pdf',['id'=>$data->id])}}" onclick="return confirm('Rostdan o`chirmoqchimisiz?')" class="btn btn-danger" ><i class="fa fa-trash" title="O'chirish"></i></a>
